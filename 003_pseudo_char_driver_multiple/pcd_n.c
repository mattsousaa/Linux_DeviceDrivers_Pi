...
int pcd_open(struct inode *inode, struct file *filp){
	...
	minor_n = MINOR(inode->i_rdev);		/* Gets the minor number */
	pr_info("minor access = %d \n", minor_n);

	/* get device's private data structure (struct cdev *i_cdev) 
	 * i_cdev is member and the container is pcdev_private_data */
